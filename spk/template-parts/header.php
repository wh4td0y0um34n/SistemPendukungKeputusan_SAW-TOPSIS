...
<body>
	...
	<header id="header">
		<div class="container clearfix">
			<div id="logo-wrap">
				<h1 id="logo"><a href="index.php"><img src="images/supplier.png" alt="" width="90px"></a></h1>
			</div>
				...
				<nav id="nav">
					<ul class="sf-menu">
						...
						<?php if($user_role == 'admin' || $user_role == 'petugas'): ?>
							<li><a href="list-kambing.php">Supplier</a>
								<ul>
									<li><a href="list-kambing.php">List Supplier</a></li>
									<li><a href="tambah-kambing.php">Tambah Supplier</a></li>
								</ul>
							</li>
						<?php endif; ?>
